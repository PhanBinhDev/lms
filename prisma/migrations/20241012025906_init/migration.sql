...
-- CreateIndex
CREATE INDEX "UserProgress_chaperId_idx" ON "UserProgress"("chaperId");

-- CreateIndex
CREATE UNIQUE INDEX "UserProgress_userId_chaperId_key" ON "UserProgress"("userId", "chaperId");
...
-- AddForeignKey
ALTER TABLE "UserProgress" ADD CONSTRAINT "UserProgress_chaperId_fkey" FOREIGN KEY ("chaperId") REFERENCES "Chapter"("id") ON DELETE CASCADE ON UPDATE CASCADE;
